...
public class GameResources {
    ...
    public static final String ENEMY_IMG_PATH = "textures/enemy.png";
    public static final String BOX_IMG_PATH = "textures/box.png";
    public static final String COOL_TRASH_IMG_PATH = "textures/cool_trash.png";
